  ...
  <div class="row justify-content-center">
    <div class="col-8">
      <form name="editForm" role="form" novalidate v-on:submit.prevent="save()">
        <h2
          id="softroboticApp.jobHistory.home.createOrEditLabel"
          data-cy="JobHistoryCreateUpdateHeading"
          v-text="$t('softroboticApp.jobHistory.home.createOrEditLabel')"
        >
        ...
        <div>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('softroboticApp.jobHistory.startDate')" for="job-history-startDate"
              >Start Date</label
            >
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('softroboticApp.jobHistory.endDate')" for="job-history-endDate">End Date</label>
            <div class="d-flex">
              <input
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('softroboticApp.jobHistory.language')" for="job-history-language">Language</label>
            <select
              class="form-control"
              name="language"
            ...
            >
              <option
                ...
                v-bind:label="$t('softroboticApp.Language.' + language)"
              >
                {{ language }}
              </option>
            </select>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('softroboticApp.jobHistory.job')" for="job-history-job">Job</label>
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('softroboticApp.jobHistory.department')" for="job-history-department"
              >Department</label
            >
          ...
          <div class="form-group">
            <label class="form-control-label" v-text="$t('softroboticApp.jobHistory.employee')" for="job-history-employee">Employee</label>
